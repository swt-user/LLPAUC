...
from hyper_tp import get_hyper
...
import pickle
def run_recbole(
    model=None, dataset=None, config_file_list=None, config_dict=None, saved=True,loss_type=None,seed=None,gpu_id=None
):
    ...
    print('########################')
    print(dataset_name,loss_type)
    new_hyper=get_hyper(dataset=dataset_name,loss=loss_type)
    for key in new_hyper.keys():
        print(key,new_hyper[key])
        config[key]=new_hyper[key]
    print('#######################')
    # dataset splitting
