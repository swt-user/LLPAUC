...
class Dataset(torch.utils.data.Dataset):
    ...
    def _remap(self, remap_list):
        ...
        np.save('adressa_field2id_token.npy',self.field2id_token)
        np.save('adressa_field2token_id.npy',self.field2token_id)
        # print(self.field2id_token)
        # print(self.field2token_id)
